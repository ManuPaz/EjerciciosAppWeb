...
public class JuegosDTO {
    ...
    public JuegosDTO(String nombre_pais, String nombre_ciudad, Integer idCiudad, String codigoPais, String descripcion_tipo_jjoo, Integer año, Integer nuevoAño, String nuevoTipoSede) {
        this.nombre_pais = nombre_pais;
        this.nombre_ciudad = nombre_ciudad;
        this.codigoPais = codigoPais;
