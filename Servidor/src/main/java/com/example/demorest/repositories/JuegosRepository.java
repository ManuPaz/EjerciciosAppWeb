...
public interface JuegosRepository extends CrudRepository<Juegos, JuegosId> {
    ...
    @Query(value = "select   new com.example.demorest.dtos.JuegosCiudades(c.id_ciudad,c.nombreciudad, p.id_pais  ,p.nombrepais , CASE WHEN c.valor_ciudad is NULL THEN p.valor_pais ELSE c.valor_ciudad  END , count(j.id.año),t.descripciontipo ) from " +
